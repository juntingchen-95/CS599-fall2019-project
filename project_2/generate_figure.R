...
ggsave(filename = paste(dir, 'result_figure_1.pdf', sep='/'), plot = plot, width = 10, height = 8)
...
ggsave(filename = paste(dir, 'result_figure_2.pdf', sep='/'), plot = plot, width = 10, height = 8)